...
- aws-config = 1.5 - https://crates.io/crates/aws-config
- aws-sdk-s3 = 1.49 - https://crates.io/crates/aws-sdk-s3
...
- Docker & Docker Compose — used to run the app, Postgres, rus3fs, and anvil (Foundry). https://www.docker.com/
...
- rustfs/rustfs:latest - S3-compatible object storage (replaces MinIO) for file uploads. https://rustfs.io/
