...
\section{Date în afara blockchain-ului și evenimente în blockchain}
...
\begin{table}[H]
    \centering
    \caption{Delimitarea informațiilor locale și a evenimentelor blockchain (elaborare proprie).}
