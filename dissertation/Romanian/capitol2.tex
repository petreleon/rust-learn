...
\begin{figure}[H]
    ...
    \end{tikzpicture}}
    \caption{Legătura dintre învățare, validare și recompensă tokenizată (elaborare proprie).}
...
\begin{table}[H]
    ...
    \begin{tabular}{P{3.1cm}P{3.8cm}P{3.8cm}P{3.8cm}}
        ...
        Audit public & Limitat la logurile operatorului & Puternic pentru evenimente on-chain & Puternic pentru tokenuri, completat de audit intern \\
        Cost operațional & Predictibil, mai ales pentru date și fișiere & Costuri pe tranzacții și contracte & Costuri controlate prin alegerea evenimentelor on-chain \\
