.PHONY: help build run stop test test-compose clean docker-build docker-up docker-down setup health runtime-verify runtime-log-scan runtime-disk docker-prune-build-cache \
  ...
  dev-refresh test-integration preflight fmt fmt-compose clippy web-dev web-lint web-build web-api-helper-tests web-architecture-scan web-lint-compose web-build-compose mock-email logs ps shell
