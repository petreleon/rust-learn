...
use crate::models::reward_candidate::{
    ...
    REWARD_EVENT_COURSE_COMPLETION, REWARD_EVENT_MANUAL_COMPLETION, REWARD_STATUS_AMOUNT_APPROVED,
    REWARD_STATUS_AMOUNT_REJECTED, REWARD_STATUS_PENDING_TEACHER_APPROVAL,
