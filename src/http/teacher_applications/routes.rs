...
use crate::http::teacher_applications::{audit, decision, handlers, platform_review};
...
fn teacher_application_scope() -> actix_web::Scope {
    web::scope("/teacher-applications")
        ...
        .service(web::resource("/{id}/decision").route(web::put().to(decision::decide_application)))
