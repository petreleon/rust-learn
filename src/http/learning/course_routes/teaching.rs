...
use crate::db;
use crate::http::learning::dto::TeacherCourseDashboardResponse;
use crate::services::course_service::{
    get_teacher_course_enrollment_workspace, get_teacher_course_students,
    get_teacher_course_workspace, TeacherCourseEnrollmentQuery,
};
use crate::utils::request_auth::authenticated_user;

use super::dto::{TeacherCourseDashboardParams, TeacherCourseEnrollmentParams};
use super::support::{
    teacher_course_dashboard_error_response, teacher_course_dashboard_list_error_response,
};
...
pub(super) async fn list_teacher_course_dashboard(
        ...
        .await
    {
        ...
        Err(error) => teacher_course_dashboard_list_error_response(error),
    }
}
