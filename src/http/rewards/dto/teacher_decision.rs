...
use crate::application::rewards::decide_teacher_candidate::{
    TeacherRewardCandidateDecisionCommand, TeacherRewardCandidateDecisionOutput,
};
...
pub struct TeacherRewardCandidateDecisionResponse {
    pub id: i64,
    pub course_id: i32,
...
impl From<TeacherRewardCandidateDecisionRequest> for TeacherRewardCandidateDecisionCommand {
    fn from(request: TeacherRewardCandidateDecisionRequest) -> Self {
        Self {
...
impl From<TeacherRewardCandidateDecisionOutput> for TeacherRewardCandidateDecisionResponse {
    fn from(candidate: TeacherRewardCandidateDecisionOutput) -> Self {
        Self {
            id: candidate.id,
