...
use crate::application::rewards::list_course_candidates::{
    CourseRewardCandidate, CourseRewardCandidatesQuery,
};
use crate::shared::json::JsonValue;

#[derive(Debug, Clone, Deserialize, Default)]
pub struct ListCourseRewardCandidatesRequest {
...
pub struct CourseRewardCandidateResponse {
    pub id: i64,
    pub course_id: i32,
...
impl From<ListCourseRewardCandidatesRequest> for CourseRewardCandidatesQuery {
    fn from(request: ListCourseRewardCandidatesRequest) -> Self {
        Self {
...
impl From<CourseRewardCandidate> for CourseRewardCandidateResponse {
    fn from(candidate: CourseRewardCandidate) -> Self {
        Self {
            id: candidate.id,
