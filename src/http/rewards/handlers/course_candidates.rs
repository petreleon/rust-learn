...
use crate::application::rewards::list_course_candidates::{
    CourseRewardCandidate, CourseRewardCandidatesUseCase,
};
use crate::http::errors::ApiError;
use crate::http::extractors::auth_user::AuthUser;
use crate::http::rewards::dto::{CourseRewardCandidateResponse, ListCourseRewardCandidatesRequest};
use crate::http::rewards::errors::course_reward_candidates_error;
...
) -> Result<web::Json<Vec<CourseRewardCandidateResponse>>, ApiError> {
    candidates
        ...
        .map(web::Json)
        .map_err(course_reward_candidates_error)
}
