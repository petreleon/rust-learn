...
pub async fn create_reward_wallet_credit_record(
...
pub async fn find_reward_wallet_credit_record_by_candidate(
    conn: &mut AsyncPgConnection,
...
pub async fn mark_reward_wallet_credit_record_notified(
    conn: &mut AsyncPgConnection,
