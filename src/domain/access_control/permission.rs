...
impl Permission {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::BlockRewardOrganization => "BLOCK_REWARD_ORGANIZATION",
            Self::BlockRewardTeacher => "BLOCK_REWARD_TEACHER",
            ...
            Self::ManageRewardFraudBlocks => "MANAGE_REWARD_FRAUD_BLOCKS",
