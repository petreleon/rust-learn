...
pub(super) fn normalize_internal_s3_host_for_debug<F>(
    host: String,
    port: &str,
    is_debug_build: bool,
    host_resolves: F,
...
pub(super) async fn configured_client(endpoint: String) -> Client {
