...
pub(super) async fn next_block_to_scan(
...
pub(super) async fn fetch_transfer_deposit_events<M: Middleware>(
    provider: &M,
...
pub(super) async fn fetch_imported_deposit_events<M: Middleware>(
    provider: &M,
    token_address: Address,
