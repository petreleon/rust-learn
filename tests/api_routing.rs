...
mod api_routing_organization_management_fake;
mod api_routing_organization_roles_fake;
mod api_routing_organization_teacher_applications_fake;
mod api_routing_reporting_fake;
mod api_routing_route_fakes;
mod api_routing_route_targets;
mod api_routing_submission_fake;
mod api_routing_teacher_application_audit_fake;
mod api_routing_teacher_application_decision_fake;
mod api_routing_teacher_application_list_fake;
mod api_routing_teacher_application_nomination_fake;
...
async fn api_scope_and_following_routes_are_reachable() {
    let app = test::init_service(
        App::new()
            ...
            .app_data(api_routing_teacher_application_audit_fake::teacher_application_audit_data())
            .app_data(api_routing_teacher_application_decision_fake::teacher_application_decision_data())
            .app_data(api_routing_teacher_application_list_fake::teacher_application_list_data())
            .app_data(api_routing_teacher_application_nomination_fake::teacher_application_nomination_data())
            .app_data(
            ...
            .app_data(api_routing_kyc_fake::kyc_audit_data())
            .app_data(api_routing_kyc_fake::kyc_review_data())
            .app_data(api_routing_kyc_fake::kyc_status_data())
            .app_data(api_routing_kyc_fake::kyc_submission_data())
            .app_data(api_routing_organization_dashboard_fake::organization_dashboard_data())
            .app_data(api_routing_organization_management_fake::organization_management_data())
            ...
            .app_data(
                api_routing_organization_roles_fake::organization_member_role_assignment_data(),
            )
            .app_data(
                api_routing_organization_teacher_applications_fake::organization_teacher_application_data(),
            )
