...
const pageTestFiles = [
  ...
  "src/features/teacher/course-content/__tests__/TeacherCourseContentCreateStatesRoute.test.tsx",
  ...
  "src/features/teacher/course-content/__tests__/TeacherCourseContentPublicationStatesRoute.test.tsx",
