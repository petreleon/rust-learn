    ...
    <main className={styles.page}>
      ...
      <section className={styles.layout}>
        <div className={styles.hero}>
          ...
          <p>
            Start with learner access, verify your email, then grow into teacher,
            organization, or platform scopes as permissions are granted.
          </p>
        ...
        <form className={styles.panel} onSubmit={submitRegistration}>
          ...
          {submitState === "success" ? (
            <div className={styles.successBox} role="status">
              ...
              <span>
                Email verification is required before login. In local development,
                the API prints the mock verification link in its logs.
              </span>
